...
export = class extends Command {
  ...
  public execute(interaction: ChatInputCommandInteraction<CacheType>): any {
    ...
    if (SUBCOMMAND_STRING === '재생') {
      ...
      interaction.reply({
        embeds: [
          new EmbedBuilder().setTitle('노래가 성공적으로 정지 되었어요.'),
        ],
      })
      ...
      interaction.reply({
        embeds: [
          new EmbedBuilder().setTitle('노래가 성공적으로 일시정지 되었어요.'),
        ],
      })
      ...
      interaction.reply({
        embeds: [
          new EmbedBuilder().setTitle('노래가 성공적으로 다시 재생 되었어요.'),
        ],
      })
      ...
      interaction.reply({
        embeds: [
          new EmbedBuilder().setTitle(`반복모드를 ${mode}로 설정했어요.`),
        ],
      })
      ...
      queue.skip()
      interaction.reply({
        embeds: [new EmbedBuilder().setTitle('현재 노래를 스킵했어요.')],
      })
